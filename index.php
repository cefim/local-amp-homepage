...
//Qui c'est ?
    $kingOfPop = "Erwann Jallier";
//Quelle plateforme?
    $coolTool = "mac";//"mac" ou "pc" ou "linux"


//vars
    $urlMachine= $_SERVER['HTTP_HOST']; 
    if(!isset($_GET['phpinfo'])) $_GET['phpinfo'] = 0;
    ...
    if($phpinfo==1){
        ...
        phpinfo();
        exit("<a href='index.php'>RETOUR</a>");
    }



// repertoires à ignorer dans les projets
    $projectsListIgnore = array ('.','..', 'phpmyadmin');
...
//personnalisation des plateforme
    switch($coolTool){
        case "pc" : 
            $amp = "WAMP";
			break;
            ...
            *, *:before, *:after {
            ...
            a, a *{
                ...
                transition: all 100ms ease-out;}
                    ...
                    #headerSite h1{margin : 0 ; color : ed7900 }

                    
                    #footerSite li      {margin : .5em 0;}
                    #footerSite a       {font-size  : 1.6em;color : black; text-decoration:none;}
                    #footerSite a:hover {color      : #c68103;}
                    #footerSite ul      {margin     : 0; padding : 0 ; list-style:none;}

                    #footerSite nav     { float : left ; width : 50%}
                    
                    #footerSite a span   {font-size : 0.6em; }
...
*/
   ...
   <footer class='wrapT' id="footerSite">
        ...
        <nav>
            <h2>Outils serveur</h2>
            <ul>
                <li class="tools linux mac">
                    <a href="http://<?= $urlMachine ?>/phpmyadmin/" title="PhpMyAdmin">
                        <i class="icon-database"></i>
                        <span>PhpMyAdmin</span>
                    </a>
                </li>
                <li class="tools linux">
                    <a href="https://<?= $urlMachine ?>:10000" target="new" title="WebMin">
                        <i class="icon-menu"></i> 
                        <span>WebMin</span>
                    </a>
                </li>
                <li class="tools linux mac">
                    <a href="index.php?phpinfo=1" title="phpinfo()">
                        <i class="icon-info"></i> 
                        <span>phpinfo()</span>
                    </a>
                </li>
        ...
        <nav class="extWeb">
              <h2>CEFIM sur le web</h2>
               <ul>
                   <li><a href="//cefim.eu" title="CEFIM"><i class="icon-globe" ></i> <span>Site Web CEFIM</span></a></li>
                   <li><a href="//plus.google.com/u/0/communities/115473612304968181395" title="Communauté Google + DL et CDI"><i class="icon-gplus"></i> <span>Communautés Google+</span></a></li>
               </ul>
           </nav>
   </footer>
    </body>
